...
class uploadMake
{
	...
	{
		return self::getInstanceByName($file_name);
	}
	 ...
	 */
	public static function getFiles($files_name)
	{
		return self::getInstancesByName($files_name);
	}
	...
	protected static function collectFilesRecursive($key, $names, $tmp_names, $types, $sizes, $errors)
	{
		if(is_array($names))
		{
			...
			self::$_files[$key] = new uploadMake($names, $tmp_names, $types, $sizes, $errors);
	}
