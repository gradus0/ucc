...
class mailSend{
	...
	function send(){
		...
		if ($socket < 0) {
			...
			// ��������� ����� � �������
			if(!socket_connect($socket, $this->conf['smtp_serv'], 25)){
				$ok=false;
		...
		if ($ok) {
			...
			$code=$this->read_smtp_answer($socket); // ����� �������
...
$test->attachment('userimages/photo/foto_03.jpg',null,'images'); // (file,namefale=null,idcid)
$test->IsHTML(); // on html
$test->send();
*/
